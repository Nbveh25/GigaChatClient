...
interface GigaChatMessagesRepository {
    ...
    /**
     * Отправляет историю в GigaChat и возвращает ответ ассистента
     * (в т.ч. [ChatAssistantReply.functionsStateId] для следующих запросов).
     * @param imageGenerationEnabled если true — запрос с text2image;
     * если false — обычный текстовый ответ.
     */
